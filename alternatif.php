<?php
session_start();
$title = "Alternatif - Preference Selection Index (PSI)";
...
if (isset($_POST['simpan'])) {
    ...
    alert('id $stambuk sudah ada !');
            ...
            $sql = "INSERT INTO tb_alternatif(stambuk,nama,jenis_kelamin,jurusan)
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a class=" btn btn-danger btn-sm hapus_mhs" href="hapus_alternatif.php?stambuk=<?= $row["stambuk"]; ?>"><i class="fas fa-trash"></i></a>
                                        </td>
                                    </tr> <!-- Edit Modal -->
                                    <div class="modal fade" id="EditModalLayanan<?= $row["stambuk"]; ?>" tabindex="-1" role="dialog" aria-labelledby="#EditModalLayananLabel" aria-hidden="true">
                                        <div class="modal-dialog modal-dialog-centered" role="document">
                                            <div class="modal-content">
                                                ...
                                                <form action="ubah_alternatif.php" method="post">
